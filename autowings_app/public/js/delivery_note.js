    ...
    frappe.call({
        ...
        callback: function(r) {
            if (r.message && r.message.length > 0) {
                const deliveryNoteTypes = r.message;
                let selectedType;
                // Prioritize matching by custom_delivery_note_label
                selectedType = deliveryNoteTypes.find(type => type.label === frm.doc.custom_delivery_note_label);
                // Fall back to custom_delivery_note_type if no label match
                if (!selectedType && frm.doc.custom_delivery_note_type) {
                ...
                if (selectedType && frm.doc.custom_delivery_note_type !== "Job Card Return") {
                    ...
                    frm.set_df_property("naming_series", "read_only", selectedType.naming_series ? 1 : 0);
                    frm.set_df_property("set_warehouse", "read_only", selectedType.warehouse ? 1 : 0);
                ...
                frappe.msgprint(__("No enabled Delivery Note types found."));
            }
        },
        error: function(err) {
                        ...
                        fields: [
                            ...
                            },
                            {
                                ...
                                fields: [
                                    ...
                                    { fieldtype: "Data", fieldname: "delivery_note_id", label: __("Delivery Note ID"), read_only: 1, in_list_view: 1 },
                                    { fieldtype: "Float", fieldname: "required_qty", label: __("Available Qty"), read_only: 1, in_list_view: 1 },
                                    {
                                        fieldtype: "Float",
                                        fieldname: "return_qty",
                                        label: __("Return Qty"),
                                ...
                                fields: [
                                    {
                                        ...
                                        fields: [
                                            { fieldtype: "Data", fieldname: "item_code", label: __("Item Code"), read_only: 1, in_list_view: 1 },
                                            { fieldtype: "Data", fieldname: "delivery_note_id", label: __("Delivery Note ID"), read_only: 1, in_list_view: 1 },
                                            { fieldtype: "Float", fieldname: "return_qty", label: __("Return Qty"), read_only: 1, in_list_view: 1 }
                                        ],
